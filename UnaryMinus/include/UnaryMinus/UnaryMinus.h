  ...
  : public DynamicComponentBase
{
 public:
   ...
   */
  UnaryMinus(RTC::Manager* manager);
...
class UnaryMinusSingle : public RTCLogicBase
{
public:
	UnaryMinusSingle(UnaryMinus *rtc)
	{
...
template <class T, class T2>
class UnaryMinusSeq : public RTCLogicBase
{
public:
	UnaryMinusSeq(UnaryMinus *rtc)
	{
...
extern "C"
{
  DLL_EXPORT void UnaryMinusInit(RTC::Manager* manager);
};
