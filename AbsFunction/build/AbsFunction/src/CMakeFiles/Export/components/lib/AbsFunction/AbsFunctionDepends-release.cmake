...
# Import target "AbsFunction" for configuration "Release"
set_property(TARGET AbsFunction APPEND PROPERTY IMPORTED_CONFIGURATIONS RELEASE)
set_target_properties(AbsFunction PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/components/lib/AbsFunction.lib"
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/components/bin/AbsFunction.dll"
  )
...
# Import target "AbsFunctionComp" for configuration "Release"
set_property(TARGET AbsFunctionComp APPEND PROPERTY IMPORTED_CONFIGURATIONS RELEASE)
set_target_properties(AbsFunctionComp PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/components/bin/AbsFunctionComp.exe"
  )
